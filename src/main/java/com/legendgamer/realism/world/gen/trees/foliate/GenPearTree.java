...
public class GenPearTree  extends WorldGenerator {

	private final  IBlockState LOG = BlocksList.REAL_PEAR.getDefaultState().withProperty(BlockRealTrees.STAGE, 6);
	private  IBlockState THICK_BRANCH ;
	
	private final  IBlockState LEAVES = BlocksList.REAL_PEAR_LEAVES.getDefaultState();
	...
	public boolean generateTree(World w, BlockPos pos) {
		...
		THICK_BRANCH = BlocksList.REAL_TB_PEAR.getDefaultState();
