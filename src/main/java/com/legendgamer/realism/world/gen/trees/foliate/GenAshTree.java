...
public class GenAshTree  extends WorldGenerator {
	...
	public boolean generateTree(World w, BlockPos pos) {
		...
		int heightTree = ThreadLocalRandom.current().nextInt(7, 12);
		boolean checkOppGrowth = true;
		THICK_BRANCH = BlocksList.REAL_TB_ASH.getDefaultState();
