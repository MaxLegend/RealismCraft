...
public class SpruceTB extends BlockThickBranch {

	public SpruceTB(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
