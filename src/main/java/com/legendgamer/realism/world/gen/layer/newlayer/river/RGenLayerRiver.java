...
public class RGenLayerRiver extends RGenLayer
{
    public RGenLayerRiver(long par1, RGenLayer par3GenLayer)
    {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int i2 = 0; i2 < par4; ++i2)
        {
            for (int j2 = 0; j2 < par3; ++j2)
            {
                ...
                {
                    aint1[j2 + i2 * par3] = Biome.getIdForBiome(RegBiomes.RIVER);
                }
            }
        }
