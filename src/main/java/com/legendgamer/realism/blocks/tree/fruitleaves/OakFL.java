...
public class OakFL extends BlockFruitLeaves {

	public OakFL(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
	...
	public void fruitUpdate(World w, BlockPos p, IBlockState s, Random r, IDate date) {
		...
		//c сент€бр€ по но€брь созревшие желуди
