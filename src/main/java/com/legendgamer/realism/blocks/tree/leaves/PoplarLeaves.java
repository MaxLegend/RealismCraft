...
public class PoplarLeaves extends BlockRealLeaves {

	public PoplarLeaves(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
	...
	public Block getFruitage() {
		return BlocksList.POPLAR_FRUIT;
	}
}