...
public class PineFL extends BlockFruitLeaves {

	public PineFL(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
	...
	public void fruitUpdate(World w, BlockPos p, IBlockState s, Random r, IDate date) {
		...
		if(date.getMonth() < 5 || date.getMonth() == 11) {
			w.setBlockState(p, BlocksList.REAL_PINE_LEAVES.getDefaultState());
		}
		...
		//c сент€бр€ по но€брь созревшие шишки
