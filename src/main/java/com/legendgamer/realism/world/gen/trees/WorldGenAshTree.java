...
public class WorldGenAshTree extends RWorldGenAbstractTree {

	public WorldGenAshTree(boolean notify, Block blockDirt, boolean useExtraRandomHeightIn) {
		super(notify, blockDirt);
		   this.useExtraRandomHeight = useExtraRandomHeightIn;
		
	}
	  private static final IBlockState LOG = BlocksList.REAL_ASH.getDefaultState();
	    private static final IBlockState LEAF = BlocksList.REAL_ASH_LEAVES.getDefaultState();
