...
public class PineTB extends BlockThickBranch {

	public PineTB(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
