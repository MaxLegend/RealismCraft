...
public class LindenTB extends BlockThickBranch {

	public LindenTB(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
