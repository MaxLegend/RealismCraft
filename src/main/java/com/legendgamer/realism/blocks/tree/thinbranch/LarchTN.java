...
public class LarchTN extends BlockTreeNewBranch {

	public LarchTN(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
