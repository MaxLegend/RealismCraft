...
public class RGenLayerZoom extends RGenLayer
{
    public static RGenLayer magnify(long par0, RGenLayer par2GenLayer, int par3)
    {
        Object var4 = par2GenLayer;
        for (int var5 = 0; var5 < par3; ++var5)
            var4 = new RGenLayerZoom(par0 + var5, (RGenLayer) var4);
        return (RGenLayer ) var4;
    }

    public RGenLayerZoom(long seed, RGenLayer par3GenLayer)
    {
        super(seed);
