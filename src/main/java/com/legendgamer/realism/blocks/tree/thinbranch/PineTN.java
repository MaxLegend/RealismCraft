...
public class PineTN extends BlockTreeNewBranch {

	public PineTN(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
