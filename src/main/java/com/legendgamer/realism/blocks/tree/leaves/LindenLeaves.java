...
public class LindenLeaves extends BlockRealLeaves {

	public LindenLeaves(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
	...
	public Block getFruitage() {
		return BlocksList.LINDEN_FRUIT;
	}
}