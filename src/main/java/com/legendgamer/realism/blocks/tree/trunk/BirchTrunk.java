...
public class BirchTrunk extends BlockRealTrees {

	public BirchTrunk(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype,
			CreativeTabs tab) {
	...
	public Block getTB() {
		return BlocksList.REAL_TB_BIRCH;
	}
	public Block getLeaves() {
		return BlocksList.REAL_BIRCH_LEAVES;
	}
}
