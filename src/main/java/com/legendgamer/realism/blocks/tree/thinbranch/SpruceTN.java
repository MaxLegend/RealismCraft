...
public class SpruceTN extends BlockTreeNewBranch {

	public SpruceTN(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
