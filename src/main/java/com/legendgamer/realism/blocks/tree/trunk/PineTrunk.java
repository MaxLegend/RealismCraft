...
public class PineTrunk extends BlockRealTrees {

	public PineTrunk(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype,
			CreativeTabs tab) {
	...
	public Block getTB() {
		return BlocksList.REAL_TB_PINE;
	}
	public Block getLeaves() {
		return BlocksList.REAL_PINE_LEAVES;
	}
}
