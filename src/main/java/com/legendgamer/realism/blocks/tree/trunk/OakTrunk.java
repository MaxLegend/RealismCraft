...
public class OakTrunk extends BlockRealTrees {

	public OakTrunk(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype,
			CreativeTabs tab) {
	...
	public Block getTB() {
		return BlocksList.REAL_TB_OAK;
	}
	public Block getLeaves() {
		return BlocksList.REAL_OAK_LEAVES;
	}
}
