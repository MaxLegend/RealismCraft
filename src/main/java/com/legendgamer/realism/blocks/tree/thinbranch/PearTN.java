...
public class PearTN extends BlockTreeNewBranch {

	public PearTN(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
