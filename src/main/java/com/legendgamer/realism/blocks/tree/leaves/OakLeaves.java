...
public class OakLeaves extends BlockRealLeaves {

	public OakLeaves(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
