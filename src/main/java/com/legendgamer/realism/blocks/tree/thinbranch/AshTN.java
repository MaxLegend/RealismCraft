...
public class AshTN extends BlockTreeNewBranch {

	public AshTN(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
