...
public class SpruceLeaves extends BlockRealLeaves {

	public SpruceLeaves(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
	...
	public Block getFruitage() {
		return BlocksList.SPRUCE_FRUIT;
	}
}
