...
public class SpruceTrunk extends BlockRealTrees {

	public SpruceTrunk(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype,
			CreativeTabs tab) {
	...
	public Block getTB() {
		return BlocksList.REAL_TB_SPRUCE;
	}
	public Block getLeaves() {
		return BlocksList.REAL_SPRUCE_LEAVES;
	}
}
