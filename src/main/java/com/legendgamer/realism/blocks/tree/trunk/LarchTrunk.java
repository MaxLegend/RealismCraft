...
public class LarchTrunk extends BlockRealTrees {

	public LarchTrunk(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype,
			CreativeTabs tab) {
	...
	public Block getTB() {
		return BlocksList.REAL_TB_LARCH;
	}
	public Block getLeaves() {
		return BlocksList.REAL_LARCH_LEAVES;
	}
}
