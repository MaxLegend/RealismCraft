...
public class BlockFoliateSapling extends BasicBlockBush {
	Block logBlock;
	Block branchBlock;
	Block leavesBlock;
	public BlockFoliateSapling(Material materialIn, String name, CreativeTabs tab, Block log, Block branch, Block leaves) {
