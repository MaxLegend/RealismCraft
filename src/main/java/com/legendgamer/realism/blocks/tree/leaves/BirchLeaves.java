...
public class BirchLeaves extends BlockRealLeaves {

	public BirchLeaves(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
