...
public class PineLeaves extends BlockRealLeaves {

	public PineLeaves(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, CreativeTabs tab) {
