...
public class AshTrunk extends BlockRealTrees {

	public AshTrunk(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype,
			CreativeTabs tab) {
