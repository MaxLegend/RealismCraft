...
//		public static final Block ASH_LOG_TD = new BlockDoubleThinLog(Material.GROUND, "tree/log_t/ash_log_td", 0, 0, SoundType.GROUND, Realism.tabTrees);
		public static final Block ASH_LOG_TX = new XZBeam(Material.WOOD, "tree/log_t/ash_log_tx", 0, 0, SoundType.WOOD, null, ItemBeam.BeamType.ASH);
		public static final Block ASH_LOG_TZ = new XZBeam(Material.WOOD, "tree/log_t/ash_log_tz", 0, 0, SoundType.WOOD, null, ItemBeam.BeamType.ASH);
		public static final Block ASH_LOG_TY = new YBeam(Material.WOOD, "tree/log_t/ash_log_ty", 0, 0, SoundType.WOOD, null, ItemBeam.BeamType.ASH);
